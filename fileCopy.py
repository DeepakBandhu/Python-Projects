...
def SourceBrowse():
	...
	root.files_list = list(filedialog.askopenfilenames(initialdir ="C:/Users/Deepak/Desktop/folderA"))
	
	root.sourceText.insert('1', root.files_list)
	
def DestinationBrowse():

	destinationdirectory = filedialog.askdirectory(initialdir ="C:/Users/Deepak/Desktop/folderB")
